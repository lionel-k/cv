...
\begin{cvdetailslist}{Réalisations}
  \item {Conception et développement du module de création et de gestion des ordonnances médicales à forte volumétrie.}
...
\begin{cvdetailslist}{Réalisations}
  ...
  \item {Mise en place de flux d'échanges via API JSON, SFTP, webhooks et fichiers XML.}
  \item {Normalisation des données financières dans un modèle unique PostgreSQL et gouvernance de la qualité des données.}
  \item {Développement d'API JSON consommées par les applications web et les espaces clients.}
...
\cvdetailblock{Compétences démontrées}{Intégration de SI · Architecture de données · API JSON · Gouvernance des données · Synchronisation multi-systèmes · Plateformes digitales · Supervision technique}
\end{cvgroup}
