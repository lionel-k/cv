...
\begin{longtable}{>{\bfseries\raggedright\arraybackslash}p{6.4cm} >{\raggedright\arraybackslash}p{10.3cm}}
  ...
  Master ou Ingéniorat en informatique / génie logiciel
    & Ingénieur (Bac+5 / niveau Master) en Réseaux et Télécommunications, UTT (France) \\

  10 ans d'expérience conception / développement SI
    & Plus de 10 ans : Covage (2015) à aujourd'hui (§5 Expérience) \\
  ...
  Intégration API REST (≥ 3 ans)
    & REST · JSON · SFTP · Webhooks · Microservices. Missions : Climb (2023–2025), Doctolib (2020–2022), Joinly (2018–2019) \\
